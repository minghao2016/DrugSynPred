function [ Precision, Recall, FPR, Max_F1, AUC] = validate( Scores, labels, varargin )
...
% FN). AUC: Area-Under-the-Curve of ROC curve.
    ...
    xlabel('Recall', 'FontSize',  12, 'FontWeight', 'bold'); ylabel('Precision', 'FontSize', 12, 'FontWeight', 'bold');
    ...
    hold off;
    xlabel('1 - Specificity', 'FontSize', 12, 'FontWeight', 'bold'); ylabel('Sensitivity', 'FontSize', 12, 'FontWeight', 'bold');
